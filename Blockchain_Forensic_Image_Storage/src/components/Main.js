...
export default function Main(props) {
  ...
  return (
    <div className="container text-center  mt-3 mb-5">
      ...
      <div className="row">
        <div className="col bg-gradient-info bg-gradient" style={{ borderRadius: 10 }}>
                    ...
                    allFiles.map((file, key) => {
                      return (
                        <tr>
                          ...
                          <td style={{ width: '12%' }}><a href={"https://ipfs.io/ipfs/" + file.fileHash} rel="noopener noreferrer" target="_blank" className="btn btn-primary">View</a></td>
                          <td style={{ width: '8%' }}>
